...
// URL H2 dédiée (distincte du "identite" partagé par IdentiteApplicationTests/
// AuthControllerIT) : cette classe est un @SpringBootTest "nu", donc Spring
// réutilise le même contexte mis en cache que IdentiteApplicationTests. Si
...
@SpringBootTest
@TestPropertySource(properties = "spring.datasource.url=jdbc:h2:mem:identite-account-adapter;MODE=MySQL;DB_CLOSE_DELAY=-1")
@Transactional
